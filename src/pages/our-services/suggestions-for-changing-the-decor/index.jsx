...
export default function SuggestionsServices() {
    ...
    return (
        ...
        <div className="suggestions-services shared-pages-with-styles page-content-explain">
            <Head>
            ...
            <section className="page-content pt-3 pb-3">
                ...
                <div className="container">
                    ...
                    <div className="row align-items-center">
                        <h1 className='page-title text-center mb-2'>{ data.servicesData[9].name }</h1>
                        {/* Start Column */}
                        ...
                        {/* Start Column */}
                        <div className="col-md-6">
                            <img src={whoAreWeImage.src} alt="Suggestions Services Image !!" className='suggestions-img page-img' />
                        </div>
                        {/* End Column */}
                    </div>
